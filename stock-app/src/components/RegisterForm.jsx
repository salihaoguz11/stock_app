...
export const registerSchema = object({
  username: string().max(10, "Please enter max 10 characters.").required(),
  first_name: string().max(20, "Please enter max 20 characters.").required(),
  last_name: string().max(20, "Please enter max 20 characters.").required(),

  email: string().email().required(),
  password: string()
    .required("password is mandator")
